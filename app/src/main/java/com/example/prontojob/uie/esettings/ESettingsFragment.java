package com.example.prontojob.uie.esettings;
...
import com.example.prontojob.databinding.FragmentESettingsBinding;
import com.google.android.material.textview.MaterialTextView;

public class ESettingsFragment extends Fragment implements View.OnClickListener {

    private MaterialTextView privacyPolicy, terms;

    private FragmentESettingsBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {

        binding = FragmentESettingsBinding.inflate(inflater, container, false);
